...
// 1. 카카오 지도로 위도경도 받아 등록
let latlng = null;
const getMap = async() =>{
var mapContainer = document.getElementById('map'), // 지도를 표시할 div 
    mapOption = { 
        center: new kakao.maps.LatLng(37.49384712, 126.724759), // 지도의 중심좌표
        level: 3 // 지도의 확대 레벨
    };
...
kakao.maps.event.addListener(map, 'click', function(mouseEvent) {        
    ...
    latlng = mouseEvent.latLng;  // var 키워드를 제거하고 JS파일 내 함수 밖에서 변수 선언
...
const onCreate = async() =>{
    ...
    // 주의할점 : form 안에 속성명은 name으로 자바의 dto 속성명과 일치하게 한다.
