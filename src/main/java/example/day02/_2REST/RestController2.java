...
public class RestController2 {
    ...
    // [ 반환타입 있는 REST ]
    //@ResponseBody : 자바는 int타입을 알지만 웹HTTP는 int 타입 누구세요?
    ...
    @ResponseBody // 자바에서 반환하는 String타입을 HTTP가 이해하는 타입으로 자동 변환
    ...
    @ResponseBody // 자바에서 반환하는 Map 타입은 HTTP 가 이해하는 타입으로 자동 변환
    ...
    @ResponseBody // 자바에서 반환하는 boolean 타입은 HTTP 가 이해하는 타입으로 자동 변환
    ...
    @ResponseBody // HTTP(를)은 List 모른다. 그래서 List 타입을 HTTP 이해하는 타입으로 자동 변환
